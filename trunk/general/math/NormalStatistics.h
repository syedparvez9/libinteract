/*
 * NormalStatistics.h
 * Computes floating-point mean and variance statistics over time. This 
 * class computes the following statistics: mean, variance and standard deviation.
 * See also: SimpleStatistics.h and Statistics.h
 *
 ...
 */
#ifndef NORMAL_STATISTICS_INC
#define NORMAL_STATISTICS_INC
